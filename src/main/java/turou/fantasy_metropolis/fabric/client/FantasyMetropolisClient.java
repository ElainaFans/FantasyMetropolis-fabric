...
public class FantasyMetropolisClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // Register orbital strike shader events
        ClientTickEvents.END_CLIENT_TICK.register(OrbitalStrikeShader.INSTANCE);
        PostWorldRenderCallback.EVENT.register(OrbitalStrikeShader.INSTANCE);
    }
}
